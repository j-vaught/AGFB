...
from agfb_generators import mach_band  # noqa: E402
...
plt.savefig(Path(__file__).with_name("mach_band_preview.png"), bbox_inches="tight", pad_inches=0)
