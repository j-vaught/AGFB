...
def smoothed_t_junction(
    ...
    *,
    ...
    """Render a smoothed T junction with three perpendicular arms."""
    return junction_frame(
        height,
        width,
        angles_rad=[theta_rad, theta_rad + math.pi / 2.0, theta_rad - math.pi / 2.0],
...
def hard_t_junction(
    ...
    *,
    ...
    """Render the sharpest band-limited T junction used by AGFB."""
